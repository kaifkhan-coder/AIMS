  ...
  const reopenTicket = async (e, id) => {
    ...
    try {
      const res = await axios.patch(
        `http://localhost:5000/api/incidents/${id}/reopen`,
...
//     try {
//       await axios.delete(`http://localhost:5000/api/incidents/${ticketId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       const res = await axios.patch(
//         `http://localhost:5000/api/incidents/${ticketId}/reopen`,
//         { reason: "User reopened the ticket" },
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }

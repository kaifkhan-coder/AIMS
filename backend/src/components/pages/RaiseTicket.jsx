  ...
  export default function RaiseTicket() {
    ...
    const predictPriority = async () => {
      ...
      try {
        const res = await axios.post(
          "${process.env.BACKEND_URL}/api/ai/predict-priority",
          {
            title: title.trim(),
            description: description.trim(),
            category,
    ...
    const generateDescriptionFromLLM = async (titleValue) => {
      ...
      try {
        ...
        const res = await axios.post(
          "${process.env.BACKEND_URL}/api/llm/suggest-description",
    ...
    const getSuggestions = async () => {
      ...
      try {
        ...
        const res = await axios.post(
          "${process.env.BACKEND_URL}/api/incidents/solution-suggestions",
          {
            title: title.trim(),
            description: description.trim(),
  ...
  const res = await axios.post(
    "${process.env.BACKEND_URL}/api/incidents/root-cause",
    {
      title,
      description
    },

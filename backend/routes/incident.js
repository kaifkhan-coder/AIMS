...
router.put("/:id/status", roleCheck("user", "admin", "staff"), updateIncidentStatus);
router.put("/:id/department", protect, roleCheck("admin", "super_admin"), updateDepartment);
